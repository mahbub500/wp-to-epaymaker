...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'wp-to-epaymaker' ),
		'products'			=> __( 'Products', 'wp-to-epaymaker' ),
		'order_total'		=> __( 'Order Total', 'wp-to-epaymaker' ),
		'commission'		=> __( 'Commission', 'wp-to-epaymaker' ),
		'payment_status'	=> __( 'Payment Status', 'wp-to-epaymaker' ),
		'time'				=> __( 'Time', 'wp-to-epaymaker' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'wp-to-epaymaker' ),
		'draft'		=> __( 'Draft', 'wp-to-epaymaker' ),
	],
];
